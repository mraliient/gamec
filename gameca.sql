...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-06-2022 a las 03:09:44
...
--
-- Base de datos: `gameca`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbl_categoria_gastos`
--
...
--
-- Volcado de datos para la tabla `tbl_categoria_gastos`
--

INSERT INTO `tbl_categoria_gastos` (`id_categoria`, `descripcion`) VALUES
(1, 'mas tabletas');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbl_categoria_gastos_farmacia`
--

CREATE TABLE `tbl_categoria_gastos_farmacia` (
  `id_categoria` int(200) NOT NULL,
  `descripcion` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `tbl_categoria_gastos_farmacia`
--

INSERT INTO `tbl_categoria_gastos_farmacia` (`id_categoria`, `descripcion`) VALUES
...
INSERT INTO `tbl_cita` (`id_cita`, `id_paciente`, `id_medico`, `fecha`, `estado_cita`, `observaciones`, `horario`) VALUES
...
(4, 21, 12, '2022-06-16', 'reservado', 'dolor muscular', '1'),
(5, 14, 17, '2022-06-16', 'reservado', 'fuerte', '1'),
(7, 16, 22, '2022-06-15', 'reservado', 'r', '1'),
(8, 13, 22, '2022-06-14', 'reservado', 'peso', '1');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbl_detalles_pedido`
--
...
--
-- Estructura de tabla para la tabla `tbl_detalles_pedido_medicina`
--

CREATE TABLE `tbl_detalles_pedido_medicina` (
  `id_detalles` int(200) NOT NULL,
  `id_pedido` int(200) NOT NULL,
  `id_producto` int(200) NOT NULL,
...
--
-- Volcado de datos para la tabla `tbl_detalles_pedido_medicina`
--

INSERT INTO `tbl_detalles_pedido_medicina` (`id_detalles`, `id_pedido`, `id_producto`, `cantidad`, `id_cliente`) VALUES
(3, 3, 4, 2, 20),
(4, 4, 5, 1, 20),
(5, 5, 5, 2, 20),
(6, 6, 5, 67, 20),
...
--
-- Estructura de tabla para la tabla `tbl_detalle_preescripcion`
--

CREATE TABLE `tbl_detalle_preescripcion` (
...
--
-- Volcado de datos para la tabla `tbl_detalle_preescripcion`
--

INSERT INTO `tbl_detalle_preescripcion` (`id_detalle_preescripcion`, `medicina`, `dosis`, `frecuencia`, `dias`, `instruccion`, `id_preescripcion`) VALUES
...
INSERT INTO `tbl_empresa` (`id_empresa`, `empresa`, `ruc`, `direccion`, `telefono`, `descripcion`, `imagen`, `correo`, `simbolo_moneda`, `tipo_moneda`) VALUES
(1, 'gameca', '4324', 'tegucigalpa', '242432334', 'clinica', 'LogoGameca.PNG', 'gameca@gmail.com', 'L.', 'lempira');
...
INSERT INTO `tbl_gastos` (`id_gastos`, `cantidad`, `nota`, `fecha`, `id_categoria`) VALUES
(1, 34, 'mas', '2022-06-16', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbl_gastos_farmacia`
--

CREATE TABLE `tbl_gastos_farmacia` (
  `id_gastos` int(200) NOT NULL,
  `cantidad` int(200) NOT NULL,
  `nota` varchar(200) NOT NULL,
  `fecha` date NOT NULL,
...
--
-- Volcado de datos para la tabla `tbl_gastos_farmacia`
--

INSERT INTO `tbl_gastos_farmacia` (`id_gastos`, `cantidad`, `nota`, `fecha`, `id_categoria`) VALUES
(1, 3, 'solo queda poco', '2020-08-08', 5),
(2, 90, 'mas', '2022-06-16', 5);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbl_history_log`
--
...
--
-- Volcado de datos para la tabla `tbl_history_log`
--

INSERT INTO `tbl_history_log` (`log_id`, `user_id`, `action`, `date`) VALUES
...
(269, 5, 'se ha desconectado el sistema en ', '2022-06-14 11:08:23'),
(270, 5, 'se ha desconectado el sistema en ', '2022-06-14 11:21:22'),
(271, 5, 'se ha desconectado el sistema en ', '2022-06-14 11:48:09'),
(272, 5, 'se ha desconectado el sistema en ', '2022-06-16 07:52:07'),
(273, 23, 'se ha desconectado el sistema en ', '2022-06-16 07:56:09'),
(274, 5, 'se ha desconectado el sistema en ', '2022-06-17 02:46:59');
...
INSERT INTO `tbl_horario` (`id_horario`, `nombre_horario`) VALUES
...
--
-- Estructura de tabla para la tabla `tbl_horario_medico`
--

CREATE TABLE `tbl_horario_medico` (
...
--
-- Volcado de datos para la tabla `tbl_horario_medico`
--

INSERT INTO `tbl_horario_medico` (`id_horario_medico`, `dia_laborable`, `hora_inicio`, `hora_fin`, `cita_duracion`, `id_medico`) VALUES
...
INSERT INTO `tbl_pedidos` (`id_pedido`, `fecha`, `id_sesion`, `id_cliente`, `tipo_venta`, `monto_pagado`, `total`, `id_medico`) VALUES
...
--
-- Estructura de tabla para la tabla `tbl_pedido_medicina`
--

CREATE TABLE `tbl_pedido_medicina` (
  `id_pedido` int(200) NOT NULL,
  `fecha` date NOT NULL,
...
--
-- Volcado de datos para la tabla `tbl_pedido_medicina`
--

INSERT INTO `tbl_pedido_medicina` (`id_pedido`, `fecha`, `id_sesion`, `id_cliente`, `tipo_venta`, `monto_pagado`, `total`, `id_medico`) VALUES
(3, '2020-08-09', 5, 20, 'Contado', 10, 10, 8),
(4, '2020-08-09', 5, 20, 'Contado', 70, 70, 8),
(5, '2020-08-09', 18, 20, 'Contado', 140, 140, 8),
(6, '2022-06-14', 5, 20, 'Contado', 4690, 4690, 8),
(7, '2022-06-16', 5, 13, 'Contado', 25, 25, 8),
(8, '2022-06-16', 5, 13, 'Contado', 200, 200, 8),
(9, '2022-06-16', 5, 13, 'Contado', 12000, 12000, 8),
(10, '2022-06-16', 23, 13, 'Contado', 115, 115, 8),
(11, '2022-06-16', 5, 21, 'Contado', 0, 0, 8);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbl_preescripcion`
--

CREATE TABLE `tbl_preescripcion` (
  `id_preescripcion` int(200) NOT NULL,
  `id_cliente` int(200) NOT NULL,
  `id_medico` int(200) NOT NULL,
...
--
-- Volcado de datos para la tabla `tbl_preescripcion`
--

INSERT INTO `tbl_preescripcion` (`id_preescripcion`, `id_cliente`, `id_medico`, `historia`, `id_sesion`, `fecha`) VALUES
...
--
-- Estructura de tabla para la tabla `tbl_procedimiento_pago`
--

CREATE TABLE `tbl_procedimiento_pago` (
...
--
-- Volcado de datos para la tabla `tbl_procedimiento_pago`
--

INSERT INTO `tbl_procedimiento_pago` (`id_procedimiento_pago`, `nombre`, `descripcion`, `precio_venta`, `estado`) VALUES
(1, 'ecografia', 'realizada on exito', 34, 'a'),
(2, 'examenes renales', 'se jodio compoa', 120, 'a');
...
INSERT INTO `tbl_producto` (`id_pro`, `nombre_pro`, `descripcion`, `unidad`, `precio_venta`, `precio_compra`, `imagen`, `stock`, `estado`) VALUES
(4, 'agua oxigenada', 'para limpiar heridas', 'botellas', 5, 4, '', '50', 'a'),
(5, 'iverctina', 'para la gripe', 'pastillas', 70, 50, '', '150', 'a'),
(6, 'alcohol', 'pa ponerse bien hig', '100', 120, 25, '', '100', 'a');
...
INSERT INTO `tbl_usuario` (`id`, `usuario`, `password`, `imagen`, `tipo`, `nombre`, `apellido`, `telefono`, `correo`) VALUES
(5, 'admin', 'a1Bz20ydqelm8m1wql21232f297a57a5a743894a0e4a801fc3', '', 'administrador', 'Clinica', 'Gameca', '54345', 'gameca@gmail.com'),
...
(21, 'mario', 'a1Bz20ydqelm8m1wql81dc9bdb52d04dc20036dbd8313ed055', '', 'paciente', 'mario', 'perez', '5656565', 'yahoo@-com'),
(22, 'yamir', 'a1Bz20ydqelm8m1wql81dc9bdb52d04dc20036dbd8313ed055', '', 'medico', 'yamir', 'e', '45454545', 'yamir@yahoo.com'),
(23, 'paco', 'a1Bz20ydqelm8m1wql81dc9bdb52d04dc20036dbd8313ed055', '', 'farmaceutico', 'pedro', 'caballas', '123123', 'pedro@gmail.com');
...
INSERT INTO `tbl_vacaciones` (`id_vacaciones`, `fecha`, `id_medico`) VALUES
(1, '2020-08-21', 17),
(2, '2020-08-28', 17),
(3, '2020-08-29', 17);
...
--
-- Indices de la tabla `tbl_categoria_gastos`
--
ALTER TABLE `tbl_categoria_gastos`
  ADD PRIMARY KEY (`id_categoria`);

--
-- Indices de la tabla `tbl_categoria_gastos_farmacia`
--
ALTER TABLE `tbl_categoria_gastos_farmacia`
  ADD PRIMARY KEY (`id_categoria`);
...
--
-- Indices de la tabla `tbl_detalles_pedido`
--
ALTER TABLE `tbl_detalles_pedido`
  ADD PRIMARY KEY (`id_detalles`);

--
-- Indices de la tabla `tbl_detalles_pedido_medicina`
--
ALTER TABLE `tbl_detalles_pedido_medicina`
  ADD PRIMARY KEY (`id_detalles`);

--
-- Indices de la tabla `tbl_detalle_preescripcion`
--
ALTER TABLE `tbl_detalle_preescripcion`
...
--
-- Indices de la tabla `tbl_gastos_farmacia`
--
ALTER TABLE `tbl_gastos_farmacia`
  ADD PRIMARY KEY (`id_gastos`);

--
-- Indices de la tabla `tbl_history_log`
--
...
--
-- Indices de la tabla `tbl_horario_medico`
--
ALTER TABLE `tbl_horario_medico`
...
--
-- Indices de la tabla `tbl_pedido_medicina`
--
ALTER TABLE `tbl_pedido_medicina`
  ADD PRIMARY KEY (`id_pedido`);

--
-- Indices de la tabla `tbl_preescripcion`
--
ALTER TABLE `tbl_preescripcion`
  ADD PRIMARY KEY (`id_preescripcion`);

--
-- Indices de la tabla `tbl_procedimiento_pago`
--
ALTER TABLE `tbl_procedimiento_pago`
...
--
-- AUTO_INCREMENT de la tabla `tbl_categoria_gastos`
--
ALTER TABLE `tbl_categoria_gastos`
  MODIFY `id_categoria` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `tbl_categoria_gastos_farmacia`
--
ALTER TABLE `tbl_categoria_gastos_farmacia`
...
--
ALTER TABLE `tbl_cita`
  MODIFY `id_cita` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `tbl_detalles_pedido`
--
ALTER TABLE `tbl_detalles_pedido`
  MODIFY `id_detalles` int(200) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `tbl_detalles_pedido_medicina`
--
ALTER TABLE `tbl_detalles_pedido_medicina`
  MODIFY `id_detalles` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `tbl_detalle_preescripcion`
--
ALTER TABLE `tbl_detalle_preescripcion`
...
--
-- AUTO_INCREMENT de la tabla `tbl_gastos_farmacia`
--
ALTER TABLE `tbl_gastos_farmacia`
  MODIFY `id_gastos` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `tbl_history_log`
--
ALTER TABLE `tbl_history_log`
...
--
-- AUTO_INCREMENT de la tabla `tbl_horario_medico`
--
ALTER TABLE `tbl_horario_medico`
...
--
-- AUTO_INCREMENT de la tabla `tbl_pedido_medicina`
--
ALTER TABLE `tbl_pedido_medicina`
  MODIFY `id_pedido` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `tbl_preescripcion`
--
ALTER TABLE `tbl_preescripcion`
  MODIFY `id_preescripcion` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `tbl_procedimiento_pago`
--
ALTER TABLE `tbl_procedimiento_pago`
  MODIFY `id_procedimiento_pago` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
